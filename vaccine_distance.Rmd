...
"Residents will only be matched with the site that’s closest to them," the [Boston Globe reported on March 10](https://www.bostonglobe.com/2021/03/10/nation/what-know-about-states-new-preregistration-system-covid-19-vaccine-appointments/). If true, there would be vast discrepancies between a site like Gillette Stadium, which is closest to approximately 400,000 adults age 18+, and the Natick Mall, which is closest to _more than 900,000_. 

Under such rules, the state would have to significantly alter vaccine distributions to make sure there were similar doses _per capita_ and not per site, in order to not heavily favor those living near Gillette and penalize residents of MetroWest and Boston.
...
The new vaccine pre-registration process did not allow people to say which sites they'd be willing to travel to. It's unclear if/how many people in metro Boston outside the "closest-to-Gillette" zone will be offered appointments at Gillette.
